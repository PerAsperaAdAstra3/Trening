...
public class TrainingController {
	...
	public String addRound(Model model, @RequestParam String hiddenClientTrainingId, @RequestParam String hiddenTrainingId) {
		...
		System.out.println("Ime jebenog trening : "+ clientService.findOne(Long.parseLong(hiddenClientTrainingId)).getName());
	...
	//	trainingService.save(training);
		...
		model.addAttribute("exercisesInRound", round.getExerciseInRound()); //List<ExerciseInRound> exercisesInRound = new ArrayList<ExerciseInRound>();
	...
	//add ExerciseInRound
	@RequestMapping(value = {"/addExerciseInRound"}, method = RequestMethod.POST)									//@RequestParam(value = "date", required = false) Date dateOrNull)
	public String addExerciseInRound(Model model, @ModelAttribute("exerciseInRoundDTO") ExerciseInRoundDTO exerciseInRoundDTO, @RequestParam(value = "roundsInTraining", required = false) List<Round> roundsInTraining,  @RequestParam String hiddenClientTrainingId, @RequestParam String hiddenTrainingId) {
